...
public class BlocFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                blocArrayList =  connexion.blocDao().getAllByBloc();
                adapter.setBlocArrayList(blocArrayList,BlocFragment.this.getActivity());
            }
        }).start();
        ...
        adapter = new BlocsAdapter(blocArrayList, new BlocsAdapter.OnBlocClickListener() {
            ...
            public void onBlocClick(Bloc bloc) {
                Intent intentToDetail = new Intent(
                        BlocFragment.this.getActivity(), DetailBlocActivity.class);
    ...
    public void reloadList(){
        new Thread(new Runnable() {
            @Override
            public void run() {
                    adapter.setBlocArrayList(dao.getAllByBloc(),getActivity());
            }
        }).start();
    }
